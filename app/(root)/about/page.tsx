            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-12 px-2 xl:px-12 mt-4'>
              <div className='flex space-x-8 mt-8'>
                ...
                <div>
                  ...
                  <p className='text-rose-600 my-2 text-lg'>Our picture uploading process is simple and intuitive. You can easily upload your pictures directly from your device. Once uploaded, you&apos;ll have access to a variety of editing tools, including cropping, adding stickers, and more.</p>
                </div>
              </div>
              ...
              <div className='flex space-x-8 mt-8'>
                ...
                <div>
                  ...
                  <p className='text-rose-600 my-2 text-lg'>We offer a free tier that allows users to edit a certain number of pictures without any cost. However, once you reach the limit of free edits, you can purchase credits to continue using our services.</p>
                </div>
              </div>
              ...
              <div className='flex space-x-8 mt-8'>
                ...
                <div>
                  ...
                  <p className='text-rose-600 my-2 text-lg'>Yes, you can save your edited pictures directly to your device or share them right away with friends!</p>
                </div>
              </div>
