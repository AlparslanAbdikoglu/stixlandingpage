...
const Phone = () => {
  return (
    <section className="place-content-center bg-black flex">
      <FloatingPhone />
      ...
      <div className="flex items-center ml-10">
        <a href="#" className="bg-blue-500 text-white inline-flex py-3 px-5 rounded-lg items-center hover:bg-blue-600 focus:outline-none">
        ...
        <div className="ml-10"></div> {/* Add some space */}
        <a href="#" className="bg-gray-700 text-white inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 focus:outline-none">
